...
public class Sentence {
	...
	Sentence(Sentence anotherSentence){
		sentenceText = anotherSentence.getSentenceText();
		sentencePos = anotherSentence.getSentencePos();
		sentenceImportance = anotherSentence.getSentenceImportance();
	}
